    ...
    async function renderCardio(force, silent) {
        ...
        try {
            ...
            el.viewContainer.innerHTML = "<section class=\"view-head\"><div><p class=\"eyebrow\">Cardio</p><h3>Intraday and resting trends</h3></div></section>" +
                ...
                "<article class=\"card span-3\"><h4>SpO2</h4>" + (latestSpO2 && latestSpO2Percent !== null ? "<p class=\"metric\">" + esc(latestSpO2Percent.toFixed(1)) + "%</p><p class=\"metric-sub\">" + esc(u.formatDateTime(latestSpO2.timestamp, s.prefs)) + "</p>" : empty("No SpO2 points for selected date.")) + "</article>" +
